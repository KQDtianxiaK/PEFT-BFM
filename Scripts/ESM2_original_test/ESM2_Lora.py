...
train_data_path = r'C:\Users\KQDtianxiaK\PycharmProjects\PEFT-PLM\datasets\ACP\iACP-DRLF\ACP20mainTrain.csv'
...
# Trainer
model = AutoPeftModelForSequenceClassification.from_pretrained(model_name, num_labels=2)

config = LoraConfig(task_type=TaskType.SEQ_CLS, target_modules=['query'])
...
model.save_pretrained(r'C:\Users\KQDtianxiaK\PycharmProjects\PEFT-PLM\path_to_save_model')
model.config.save_pretrained(r'C:\Users\KQDtianxiaK\PycharmProjects\PEFT-PLM\path_to_save_model')