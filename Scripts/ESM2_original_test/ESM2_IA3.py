...
train_data_path = r'C:\Users\KQDtianxiaK\PycharmProjects\PEFT-PLM\datasets\ACP\Anticancer-Peptides-CNN\acp740_all.csv'
...
config = IA3Config(task_type=TaskType.SEQ_CLS, target_modules=['query', 'output.dense'], feedforward_modules=['output.dense'])
model_IA3 = get_peft_model(model, config)

optimizer = AdamW(model.parameters(), lr=5e-5)

trainer = Trainer(model=model_IA3,
                  args=train_Args,
...
print(mtrics)
print(model_IA3.print_trainable_parameters())