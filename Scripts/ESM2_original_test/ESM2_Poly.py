...
config = PolyConfig(task_type=TaskType.SEQ_CLS, target_modules=['query'])
model_Poly = get_peft_model(model, config)

trainer = Trainer(model=model_Poly,
                  args=train_Args,
...
print(mtrics)
print(model_Poly.print_trainable_parameters())