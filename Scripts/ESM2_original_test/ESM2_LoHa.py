...
config = LoHaConfig(task_type=TaskType.SEQ_CLS, target_modules=['query'])
model_LoHa = get_peft_model(model, config)

trainer = Trainer(model=model_LoHa,
                  args=train_Args,
...
print(mtrics)
print(model_LoHa.print_trainable_parameters())